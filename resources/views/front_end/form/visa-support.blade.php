    ...
    <div class="row">
        ...
        <div class="col-md-8" style="padding-top: 20px;padding-bottom: 20px">
            <div class="card comp-card">
                <div class="card-body">
                    <h3 style="text-align: center;">Visa Support</h3>
                    <form action="#" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="recipient-name" name="car" required
                                   value="{{old('car')}}" placeholder="Which country visa do you need?">
                        </div>
                        <div class="form-group">
