...
{{--                                        @endforeach--}}
                            ...
                            <div class="form-row mb-3">
                                <div class="col">
                                    ...
                                    <input type="date" name="package_schedule" id="" class="form-control form-control-sm" value="{{ $edit_schedule->package_schedule }}">
                                </div>
                                <div class="col">
                                    <small>Select schedule departure <sup class="text-danger">*</sup></small>
                                    <input type="time" name="package_schedule_time" id="" class="form-control form-control-sm" value="{{ $edit_schedule->package_schedule_time }}">
                                </div>
                            </div>
                            ...
                            <div class="form-row mb-3">
                                <div class="col">
                                    ...
                                    <input type="number" name="package_max_member" id="" class="form-control form-control-sm" value="{{ $edit_schedule->package_max_member }}">
                                </div>
                            </div>
                            <div class="form-row mb-3">
                                <div class="col">
                                    <small>Extra Description <sup class="text-danger"></sup></small>
                                    <textarea name="package_ex_description" id="packageDescription">{{ $edit_schedule->package_ex_description }}</textarea>
                                </div>
                            </div>
                            <div class="form-row mb-3">
                                <div class="col">
